(() => {
    ...
    function initSliders() {
        ...
        const blockquotesSlider = new swiper_core_Swiper(".blockquotes-slider", {
            modules: [ EffectFade ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".frameworks-slider")) new swiper_core_Swiper(".frameworks-slider", {
        ...
        if (document.querySelector(".partnership-rules-slider")) new swiper_core_Swiper(".partnership-rules-slider", {
            modules: [ Navigation, A11y ],
            navigation: {
    ...
    const listItems = document.querySelectorAll(".postulates__list-item-button");
    ...
    const activeNumberItem = n => {
        for (let numberItem of numberItems) numberItem.classList.remove("active");
        numberItems[n].classList.add("active");
    };
    const activePostBckgImg = n => {
        for (let postBckgImg of postBckgImgs) postBckgImg.classList.remove("active");
        postBckgImgs[n].classList.add("active");
    };
    const activePostParagraph = n => {
        for (let postParagraph of postParagraphs) {
